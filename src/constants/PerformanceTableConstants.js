export const PERFORMANCE_DESCRIPTIONS = {
  "HTTP/2 Support": {
    ...
    description: `HTTP/2 is a major revision of the HTTP network protocol that improves website performance.
...
• Optimize server configuration`,
  ...
  "CSS Minification": {
    ...
    description: `Minification removes unnecessary characters from CSS files to reduce file size and improve load times.
...
• Implement CSS caching`,
  ...
  "JS Minification": {
    ...
    description: `JavaScript minification reduces code size by removing unnecessary characters without changing functionality.
...
• Implement code splitting`,
  ...
  "Inline Styles": {
    ...
    description: `Inline styles are CSS properties written directly in HTML elements. Too many can impact maintenance and page load.
...
• Use style components or CSS modules`,
  ...
  "Deprecated HTML": {
    ...
    description: `Deprecated HTML tags are old elements that are no longer recommended for use in modern web development.
...
• Follow W3C recommendations`,
  ...
  "Page Load Speed": {
    ...
    description: `The time it takes for your page to fully load. Crucial for user experience and SEO performance.
