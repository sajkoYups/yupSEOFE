export const LINKS_DESCRIPTIONS = {
  "Internal Page Links": {
    ...
    description: `Links that connect different pages within your website. They help distribute page authority and create a logical site structure.
...
• Regularly audit internal links`,
  ...
  "Internal Section Links": {
    ...
    description: `Links that navigate to different sections within the same page. They improve user experience and content accessibility.
...
• Ensure proper HTML structure`,
  ...
  "Broken Links": {
    ...
    description: `Links that lead to non-existent pages or resources. They create poor user experience and can harm SEO performance.
